                ...
                <div class="col-md-4">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <p class="card-text" id="ttl-lembur">{{ $lemburCountUser }}</p>
                ...
                <div class="col-md-4">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <p class="card-text" id="ttl-">{{ $lemburCountUP }}</p>
                        </div>
                    </div>
                </div>
                <div class="col-md-4">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <p class="card-text" id="ttl-">{{ $lemburCountUS }}</p>
                        </div>
                    </div>
                </div>
                <div class="col-md-4">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <p class="card-text" id="ttl-">{{ $lemburCountUR }}</p>
                        </div>
                    </div>
                </div>
